    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semibold text-4xl leading-tight mt-8">
                ...
                <div class="text-gray-400 mt-5">
                    ...
                    &middot;
                    <span>
                        {{ $game['involvedCompanies'] ?? 'Unknown Company' }}
                    </span>
                    <span>
                ...
                <div class="flex flex-wrap items-center mt-5">
                    ...
                    <div class="flex items-center space-x-4 ml-12">
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            @if (isset($game['social']['official_website']) && $game['social']['official_website'])
                            <a href="{{ $game['social']['official_website']['url'] }}" target="_blank" rel="noopener noreferrer" class="hover:text-gray-400">
                            ...
                            @else
                            <span class="text-white text-xs">N/A</span>
                            @endif
                        </div>
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            @if (isset($game['social']['instagram']) && $game['social']['instagram'])
                            <a href="{{ $game['social']['instagram']['url'] }}" target="_blank" rel="noopener noreferrer" class="hover:text-gray-400">
                        ...
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            @if (isset($game['social']['twitter']) && $game['social']['twitter'])
                            <a href="{{ $game['social']['twitter']['url'] }}" target="_blank" rel="noopener noreferrer" class="hover:text-gray-400">
                        ...
                        <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                            @if (isset($game['social']['facebook']) && $game['social']['facebook'])
                            <a href="{{ $game['social']['facebook']['url'] }}" target="_blank" rel="noopener noreferrer" class="hover:text-gray-400">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                ...
                <div>
                    <a href="{{ $screenshot['big'] }}">
                        <img src="{{ $screenshot['huge'] }}" alt="screenshot">
                    </a>
                </div>
                @endforeach
                @else
